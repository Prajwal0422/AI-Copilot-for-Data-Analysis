export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-900/10 via-transparent to-purple-900/10 animate-pulse"></div>
        ...
        <div className="flex items-center justify-between relative z-10">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-500">
              <span className="px-2 py-1 bg-purple-900/20 text-purple-400 rounded font-medium shadow-sm">GPT-4</span>
      ...
      <div className="grid grid-cols-[280px_1fr_380px] h-[calc(100vh-73px)] gap-0 relative">
        ...
        <div className="border-r border-gray-800 p-6 overflow-y-auto bg-gradient-to-b from-gray-900/50 to-transparent relative z-10">
          <h2 className="text-sm font-semibold mb-6 text-gray-300 uppercase tracking-wide flex items-center gap-2">
            ...
            <span className="ml-auto text-xs bg-blue-900/30 text-blue-400 px-2 py-1 rounded-full font-medium animate-pulse shadow-sm">2</span>
          </h2>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs bg-green-900/30 text-green-400 px-1.5 py-0.5 rounded font-semibold shadow-sm">Active</span>
                  </div>
        ...
        <div className="p-6 flex flex-col bg-gradient-to-b from-transparent via-gray-900/30 to-transparent relative z-10">
          ...
          <h2 className="text-sm font-semibold mb-6 text-gray-300 uppercase tracking-wide flex items-center gap-2">
            ...
            <span className="ml-auto text-xs bg-gray-800 text-gray-400 px-2 py-1 rounded-full font-medium shadow-sm">2 messages</span>
          </h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end animate-fade-in group">
                  <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl rounded-tr-sm px-4 py-3 max-w-[80%] shadow-lg shadow-blue-900/50 hover:shadow-blue-800/60 transition-shadow cursor-pointer">
                    <div className="text-sm font-semibold leading-relaxed">Analyze sales trends</div>
            ...
            <div className="mt-4 flex gap-2">
              <input 
                ...
                className="flex-1 bg-gray-900/80 backdrop-blur-sm border border-gray-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all placeholder:text-gray-600 hover:border-gray-700 focus:bg-gray-900"
              />
          ...
          <div>
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-800 p-4 hover:border-gray-700 transition-colors shadow-inner">
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-800 transition-colors cursor-pointer">
                  ...
                  <div className="ml-auto text-xs text-green-500 font-semibold shadow-sm">Complete</div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded-lg bg-blue-900/20 border border-blue-800/50 cursor-pointer">
                  ...
                  <div className="ml-auto text-xs text-blue-400 font-semibold shadow-sm">In Progress</div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-800 transition-colors cursor-pointer opacity-60 hover:opacity-80">
                  ...
                  <div className="text-sm text-gray-500 font-medium">Generate insights</div>
                  <div className="ml-auto text-xs text-gray-600 font-semibold">Pending</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-l border-gray-800 p-6 overflow-y-auto bg-gradient-to-b from-gray-900/50 to-transparent relative z-10">
          <h2 className="text-sm font-semibold mb-6 text-gray-300 uppercase tracking-wide flex items-center gap-2">
            ...
            <span className="ml-auto text-xs bg-yellow-900/30 text-yellow-400 px-2 py-1 rounded-full font-medium animate-pulse shadow-sm">Live</span>
          </h2>
